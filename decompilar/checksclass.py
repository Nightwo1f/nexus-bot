...
public final class Checks {
  public static final boolean CHECKS = !((Boolean)Configuration.DISABLE_CHECKS.get(Boolean.valueOf(false))).booleanValue();
  
  public static final boolean DEBUG = ((Boolean)Configuration.DEBUG.get(Boolean.valueOf(false))).booleanValue();
  
  public static final boolean DEBUG_FUNCTIONS = ((Boolean)Configuration.DEBUG_FUNCTIONS.get(Boolean.valueOf(false))).booleanValue();
