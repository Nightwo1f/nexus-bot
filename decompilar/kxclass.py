...
public final class kx {
  ...
  private static void c(Stage paramStage) {
    if (m == null || m.getStage() != paramStage) {
      if (m != null)
        m.remove(); 
      (m = new Group()).setName("PopupMessageOverlay");
  ...
  private static void a(Stage paramStage, String paramString, cq paramcq) {
    ...
    if (bool) {
      ...
      table2.setPosition(Math.round(f3), Math.round((f2 - f6) / 2.0F));
    } else {
      float f5 = f3 - table2.getWidth() / 2.0F;
      float f6 = (f2 - table2.getHeight()) * 0.4F;
    ...
    table2.addAction((Action)Actions.parallel((Action)Actions.sequence((Action)Actions.fadeIn(0.35F), (Action)Actions.delay(3.0F), (Action)Actions.fadeOut(0.35F), (Action)Actions.run(() -> {
                ...
                if (g == paramTable)
                  g = null; 
              })), (Action)Actions.forever(new ky(paramStage, table2, bool))));
  }
    ...
    for (byte b = 0; b < paramString.length(); b++) {
      ...
      if ((i = paramString.charAt(b)) == '\n') {
        if (stringBuilder.length() > 0) {
          arrayList.add(kz.a(stringBuilder.toString()));
          stringBuilder.setLength(0);
        } 
        arrayList.add(new kz(la.d, null, -1));
        b++;
        continue;
      } 
      if (b + 2 < paramString.length() && paramString.charAt(b) == '&& paramString.charAt(b + 1) == '&& C.containsKey(Character.valueOf(paramString.charAt(b + 2)))) {
        if (stringBuilder.length() > 0) {
          arrayList.add(kz.a(stringBuilder.toString()));
          stringBuilder.setLength(0);
        } 
        i = ((Integer)C.get(Character.valueOf(paramString.charAt(b + 2)))).intValue();
        arrayList.add(new kz(la.c, null, i));
        b += 3;
        continue;
      } 
  ...
  private static Table a(String paramString, Label.LabelStyle paramLabelStyle, float paramFloat1, float paramFloat2) {
    ...
    float f2 = 0.0F;
    Iterator<kz> iterator = d(paramString).iterator();
    while (iterator.hasNext()) {
      Image image;
      kz kz;
      if ((kz = iterator.next()).a == la.d) {
        a(table1, table2);
        (table2 = (new Table()).center()).defaults().center();
        f2 = 0.0F;
        continue;
      ...
      if (kz.a == la.c) {
        ...
        if (b.c != null && kz.eF >= 0 && kz.eF < b.c.length)
          bitmapFont = b.c[kz.eF]; 
      ...
      int i = (arrayOfString = ((kz)image).aN.split("(?<=\\s)|(?=\\s)")).length;
      for (byte b = 0; b < i; b++) {
        String str;
  ...
  static {
    (C = new HashMap<>()).put(Character.valueOf('), Integer.valueOf(0));
    C.put(Character.valueOf('), Integer.valueOf(1));
    C.put(Character.valueOf('), Integer.valueOf(2));
    C.put(Character.valueOf('), Integer.valueOf(3));
    C.put(Character.valueOf('), Integer.valueOf(4));
    C.put(Character.valueOf('), Integer.valueOf(5));
    C.put(Character.valueOf('), Integer.valueOf(6));
    C.put(Character.valueOf('), Integer.valueOf(7));
    C.put(Character.valueOf('), Integer.valueOf(8));
    C.put(Character.valueOf('), Integer.valueOf(9));
    C.put(Character.valueOf('), Integer.valueOf(10));
    C.put(Character.valueOf('), Integer.valueOf(11));
    C.put(Character.valueOf('), Integer.valueOf(12));
    C.put(Character.valueOf('), Integer.valueOf(13));
    C.put(Character.valueOf('), Integer.valueOf(14));
    C.put(Character.valueOf('), Integer.valueOf(15));
    C.put(Character.valueOf('), Integer.valueOf(16));
    C.put(Character.valueOf('), Integer.valueOf(17));
    C.put(Character.valueOf('), Integer.valueOf(18));
    C.put(Character.valueOf('), Integer.valueOf(19));
    C.put(Character.valueOf('), Integer.valueOf(20));
    C.put(Character.valueOf('), Integer.valueOf(21));
    C.put(Character.valueOf('), Integer.valueOf(22));
    C.put(Character.valueOf('), Integer.valueOf(23));
  }
}
